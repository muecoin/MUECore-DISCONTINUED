...
Format: ```mngovernance prepare proposal-name url payment-count block-start mue-address monthly-payment-mue```
...
Format: ```mngovernance submit proposal-name url payment-count block-start mue-address monthly-payment-mue fee-tx```
...
The following RPC commands are supported:
 ...
 - mngovernance "command"... ( "passphrase" )
  ...
  - vote               - Vote on a proposal by single masternode (using mue.conf setup)
