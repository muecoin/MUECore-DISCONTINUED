...
MonetaryUnit Core version 0.12.0 is now available from:
  ...
  https://muepay.io/downloads

Please report bugs using the issue tracker at github:

  https://github.com/muecoin/mue/issues
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/mue/).
