...
const char * const BITCOIN_CONF_FILENAME = "mue.conf";
const char * const BITCOIN_PID_FILENAME = "mued.pid";
...
bool LogAcceptCategory(const char* category)
{
    if (category != NULL)
    {
        ...
        if (ptrCategory.get() == NULL)
        {
            ...
            // "mue" is a composite category enabling all MonetaryUnit-related debug output
            if(ptrCategory->count(string("mue"))) {
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    {
        // Don't overwrite existing settings so command line settings override mue.conf
