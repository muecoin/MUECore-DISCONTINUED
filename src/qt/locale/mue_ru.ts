...
<context>
    ...
    <message>
        ...
        <translation>Сейчас MonetaryUnit Core закроется для завершения процесса шифрования. Помните, что шифрование вашего кошелька не может полностью защитить ваши даши от кражи с помощью инфицирования вашего компьютера вредоносным ПО.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Запросить платежи (создать QR-коды и mue: URI)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подписать сообщения вашими адресами MonetaryUnit, чтобы доказать, что вы ими владеете</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Проверить сообщения, чтобы удостовериться, что они были подписаны определёнными адресами MonetaryUnit</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Открыть mue: URI или запрос платежа</translation>
    </message>
    <message>
    ...
    <message numerus="yes">
        ...
        <translation><numerusform>%n активное соединение с сетью MonetaryUnit</numerusform><numerusform>%n активных соединения с сетью MonetaryUnit</numerusform><numerusform>%n активных соединений с сетью MonetaryUnit</numerusform><numerusform>%n активных соединений с сетью MonetaryUnit</numerusform></translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Изменить параметры конфигурации MonetaryUnit Core</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Показать помощь о MonetaryUnit Core со списком возможных параметров командной строки</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Введённый адрес "%1" не является правильным адресом MonetaryUnit.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>MonetaryUnit Core скачает и сохранит копию цепочки блоков. Как минимум %1ГБ данных будет храниться в этом каталоге и размер данных будет со временем расти. В этом же каталоге будет сохранён кошелёк.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Сумма постоянно анонимизированных MonetaryUnit</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Автоматически запускать MonetaryUnit Core после входа в систему.</translation>
    </message>
    <message>
        <source>&amp;Start MonetaryUnit Core on system login</source>
        <translation>&amp;Запускать MonetaryUnit Core при входе в систему</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Автоматически открыть порт для MonetaryUnit Core на роутере. Работает только в том случае, если Ваш роутер поддерживает UPnP и данная функция включена.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Здесь можно выбрать язык интерфейса. Настройки вступят в силу после перезапуска MonetaryUnit Core.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подключаться к сети MonetaryUnit через отдельный прокси SOCKS5 для скрытых сервисов Tor.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Отображаемая информация может быть устаревшей. Ваш кошелёк автоматически синхронизируется с сетью MonetaryUnit после подключения, но этот процесс пока не завершён.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Не удаётся запустить обработчик mue: click-to-pay</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Не удалось разобрать URI! Возможно указан некорректный адрес MonetaryUnit либо параметры URI сформированы неверно.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Открыть отладочный лог-файл MonetaryUnit Core из текущего каталога данных. Для больших лог-файлов эта операция может занять несколько секунд.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Добро пожаловать в RPC-консоль MonetaryUnit Core.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Необязательное сообщение для запроса платежа, которое будет показано при открытии запроса. Обратите внимание: сообщение не будет отправлено вместе с платежом через сеть MonetaryUnit.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Необязательное сообщение для запроса платежа, которое будет показано при открытии запроса.&lt;br&gt;Обратите внимание: сообщение не будет отправлено вместе с платежом через сеть MonetaryUnit.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Адрес MonetaryUnit для отправки на него монет</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Комиссия будет вычтена из отправляемой суммы. Получателю придет меньше MonetaryUnit, сем указано в поле "Сумма". Если указано несколько получателей, то комиссия будет разделена между ними поровну.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>К mue: URI было прикреплено сообщение, которое будет сохранено вместе с транзакцией для вашего сведения. Обратите внимание: сообщение не будет отправлено через сеть MonetaryUnit.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Вы можете подписывать сообщения своими адресами, чтобы доказать, что Вы можете получать MonetaryUnit на них. Будьте осторожны, не подписывайте что-то неопределённое, так как фишинговые атаки могут обманным путём заставить вас подписать нежелательные сообщения. Подписывайте только те сообщения, с которыми вы согласны вплоть до мелочей.</translation>
    </message>
    <message>
        <source>The MonetaryUnit address to sign the message with</source>
        <translation>Адрес MonetaryUnit, которым Вы хотите подписать сообщение</translation>
    </message>
    <message>
        <source>Choose previously used address</source>
        <translation>Выбрать ранее использованный адрес</translation>
    ...
    <message>
        ...
        <translation>Подписать сообщение, чтобы доказать владение этим адресом MonetaryUnit</translation>
    </message>
    <message>
        <source>Sign &amp;Message</source>
        <translation>Подписать &amp;сообщение</translation>
...
<context>
    ...
    <message>
        ...
        <translation>Не удалось привязаться к %s на этом компьютере. Возможно, MonetaryUnit Core уже запущен.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Ошибка загрузки wallet.dat: кошелёк требует более новой версии MonetaryUnit Core</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Проверка на непротиворечивость закончилась неудачно. MonetaryUnit Core выключается.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Необходимо перезаписать кошелёк: перезапустите MonetaryUnit Core для завершения операции</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Отключить всю функциональность, относящуюся к MonetaryUnit (Мастерноды, PrivateSend, InstantSend, Governance) (0-1, по умолчанию: %u)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Пожалуйста, убедитесь что дата и время на Вашем компьютере выставлены правильно! MonetaryUnit Core не сможет работать корректно, если часы настроены неверно.</translation>
    </message>
    <message>
