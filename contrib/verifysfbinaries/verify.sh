...
WORKINGDIR="/tmp/MUECore"
TMPFILE="hashes.tmp"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://MonetaryUnit.org/bin/"
VERSIONPREFIX="MonetaryUnit-core-"
RCVERSIONSTRING="rc"
...
if [ $RET -ne 0 ]; then
   if [ $RET -eq 1 ]; then
      ...
      echo "gpg error. Do you have the MonetaryUnit Core binary release signing key installed?"
   fi
